  ...
  return <section id="media-partners" className="py-16 lg:py-24 bg-background">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="body-large max-w-2xl mx-auto mb-8">From the Loop to Little Village, reach every community that matters to your brand. Simply share your marketing goals and we'll do the rest!</p>
