...
echo "  ✓ Backend API to ECS (https://api.localmedia.store)"
echo "  ✓ Frontend to Amplify (https://admin.localmedia.store)"
echo ""
...
echo "   Frontend: https://admin.localmedia.store"
echo "   API:      https://api.localmedia.store"
echo ""
