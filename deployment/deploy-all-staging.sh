...
echo "  ✓ Backend API to ECS (https://staging-api.localmedia.store)"
echo "  ✓ Frontend to Amplify (https://staging-admin.localmedia.store)"
echo ""
...
echo ""
echo "🌐 Staging URLs:"
echo "   Frontend: https://staging-admin.localmedia.store"
echo "   API:      https://staging-api.localmedia.store"
echo ""
